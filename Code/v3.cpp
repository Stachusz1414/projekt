...
void generatePlatform(float& lastPlatformY, std::vector<sf::RectangleShape>& platforms,
    std::list<DisappearingPlatform>& disappearingPlatforms, std::vector<Spike>& spikes,
    int phase, sf::RectangleShape& ground, const Player& player) {
    pc += 1;
...
int main() {
    ...
    for (int i = 0; i < MAX_PLATFORMS; ++i) {
        generatePlatform(lastPlatformY, platforms, disappearingPlatforms, spikes, Phase, ground, player);
    }
